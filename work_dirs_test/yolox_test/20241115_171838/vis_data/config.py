...
model = dict(
    ...
    train_cfg=dict(assigner=dict(center_radius=2.5, type='OTAAssigner')),
    type='YOLOX')
num_last_epochs = 15
optim_wrapper = dict(
    optimizer=dict(
...
randomness = dict(deterministic=True, diff_rank_seed=True, seed=2023)
resume = False
...
work_dir = './work_dirs_test/yolox_test'
