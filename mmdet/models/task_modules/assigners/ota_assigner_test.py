...
class OTAAssigner_test(BaseAssigner):
    ...
    def assign(self,
        ...
        return AssignResult(
            num_gt, assigned_gt_inds, max_overlaps, labels=assigned_labels), dynamic_ks, topk_ious, top_index, valid_mask_iou, cost_matrix
